...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener, SearchableItem{

    public static final int NO_ITEM_SELECTED = -1;
    private Context _context;
    private List _items;
    private SearchableDialog _searchableListDialog;
    ...
    private void init() {
        ...
        _searchableListDialog = SearchableDialog.newInstance
                (_items);
